...
Run: `DATABASE_URL_TEST=postgres://jobradar:jobradar@localhost:5432/jobradar npm run test:integration`
...
- [ ] `cd backend && DATABASE_URL_TEST=postgres://jobradar:jobradar@localhost:5432/jobradar npm run test:integration` — Vitest integration suite green
